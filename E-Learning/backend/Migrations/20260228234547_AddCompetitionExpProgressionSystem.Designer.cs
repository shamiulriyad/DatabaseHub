...
namespace backend.Migrations
{
    ...
    [Migration("20260228234547_AddCompetitionExpProgressionSystem")]
    partial class AddCompetitionExpProgressionSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetition", b =>
                {
                    ...
                    b.Property<int>("ChallengerClanId")
                        .HasColumnType("integer");

                    b.Property<bool>("ChallengerReady")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<string>("OpponentResponse")
                        .HasColumnType("text");

                    b.Property<int?>("OpponentTotalScore")
                        .HasColumnType("integer");

                    b.Property<int>("ParticipantsPerClan")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(3);
                    ...
                    b.Property<bool>("ShowScoresToOpponent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.Property<string>("WinnerClanStatus")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.HasKey("Id");

                    b.HasIndex("ChallengerClanId");

                    b.HasIndex("CreatedAt");

                    b.HasIndex("CreatedByUserId");

                    b.HasIndex("OpponentClanId");
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetitionParticipant", b =>
                {
                    ...
                    b.Property<string>("AnswerSubmissions")
                        .HasColumnType("text");

                    b.Property<int>("ClanId")
                        .HasColumnType("integer");

                    b.Property<int?>("ClanVsClansCompetitionId")
                        .HasColumnType("integer");

                    b.Property<int?>("ClanVsClansCompetitionId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClanVsClansCompetitionId");

                    b.HasIndex("ClanVsClansCompetitionId1");
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetitionScore", b =>
                {
                    ...
                    b.Property<int>("ClanContributionToTotal")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("NegativePointsPerWrongAnswer")
                        .HasColumnType("integer");

                    b.Property<int>("ParticipantId")
                        .HasColumnType("integer");

                    b.Property<int>("PointsPerCorrectAnswer")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetition", b =>
                {
                    b.HasOne("backend.Models.Clan", "ChallengerClan")
                        .WithMany("ChallengedCompetitions")
                        .HasForeignKey("ChallengerClanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("backend.Models.Clan", "OpponentClan")
                        .WithMany("OpponentCompetitions")
                        .HasForeignKey("OpponentClanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ChallengerClan");

                    b.Navigation("CreatedBy");

                    b.Navigation("OpponentClan");
                });
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetitionParticipant", b =>
                {
                    ...
                    b.HasOne("backend.Models.ClanVsClansCompetition", null)
                        .WithMany("ChallengerParticipants")
                        .HasForeignKey("ClanVsClansCompetitionId");

                    b.HasOne("backend.Models.ClanVsClansCompetition", null)
                        .WithMany("OpponentParticipants")
                        .HasForeignKey("ClanVsClansCompetitionId1")
                        .HasConstraintName("FK_ClanVsClansCompetitionParticipants_ClanVsClansCompetitions~1");

                    b.HasOne("backend.Models.ClanVsClansCompetition", "Competition")
                        .WithMany("AllParticipants")
                        .HasForeignKey("CompetitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ClanVsClansCompetitionParticipants_ClanVsClansCompetitions~2");
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetitionScore", b =>
                {
                    ...
                    b.HasOne("backend.Models.ClanVsClansCompetitionParticipant", "Participant")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Clan", b =>
                {
                    b.Navigation("ChallengedCompetitions");
                    ...
                    b.Navigation("OpponentCompetitions");
            ...
            modelBuilder.Entity("backend.Models.ClanVsClansCompetition", b =>
                {
                    b.Navigation("AllParticipants");

                    b.Navigation("ChallengerParticipants");

                    b.Navigation("OpponentParticipants");
