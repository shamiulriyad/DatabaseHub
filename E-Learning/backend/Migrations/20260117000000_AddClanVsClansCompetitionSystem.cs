...
{
    /// <inheritdoc />
    public partial class AddClanVsClansCompetitionSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantsPerClan = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ChallengerReady = table.Column<bool>(type: "boolean", nullable: false),
                    OpponentReady = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    ShowScoresToOpponent = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClanVsClansCompetitionQuestions_ClanVsClansCompetitions_CompetitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClanVsClansCompetitionParticipants_ClanVsClansCompetitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "ClanVsClansCompetitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClanVsClansCompetitionScores_ClanVsClansCompetitionParticipants_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "ClanVsClansCompetitionParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClanVsClansCompetitionScores_ClanVsClansCompetitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "ClanVsClansCompetitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
